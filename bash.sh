...
sudo apt install gnome-control-center software-properties-gtk gnome-backgrounds gnome-terminal firefox chromium-browser nautilus pcmanfm gnome-tweaks gnome-software -y
sudo apt install git gnome-shell-extensions chrome-gnome-shell gnome-tweak-tool -y
sudo git install curl -y
echo "Done!"